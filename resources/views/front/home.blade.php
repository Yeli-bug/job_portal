                ...
                <div class="row">
                    ...
                    <div class=" col-md-3 mb-xs-3 mb-sm-3 mb-lg-0">
                        <div class="d-grid gap-2">
                            {{11-- <a href="jobs.html" class="btn btn-primary btn-block">Search</a> 
        ...
        <div class="row pt-5">
            ...
            <div class="col-lg-4 col-xl-3 col-md-6">
                <div class="single_catagory">
                    ...
                    <p class="mb-0"> <span>0</span>Posiciones disponibles</p>
                </div>
            </div> 
            @endforeach                
            @endif
                                ...
                                <div class="card border-0 p-3 shadow mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="d-grid mt-3">
                                            <a href="{{ route('jobDetail',$featuredJob->id) }}" class="btn btn-primary btn-lg">Detalles</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
