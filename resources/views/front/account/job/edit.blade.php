                        ...
                        <div class="card-body card-form p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="experience" id="experience" class="form-control">
                                    <option value="1" {{ ($job->experience == 1) ? 'selected' : '' }}>6 meses</option>
                                    <option value="2" {{ ($job->experience == 2) ? 'selected' : '' }}>1 año</option>
                                    <option value="3" {{ ($job->experience == 3) ? 'selected' : '' }}>2 años</option>
                                    <option value="4" {{ ($job->experience == 4) ? 'selected' : '' }}>3 años</option>
                                    <option value="5" {{ ($job->experience == 5) ? 'selected' : '' }}>4 años</option>
                                </select>
                                <p></p>
                            </div>
