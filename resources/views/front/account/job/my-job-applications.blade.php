                                ...
                                <tbody class="border-0">
                                    @if ($jobApplications->isNotEmpty())
                                        ...
                                        <tr class="active">
                                            ...
                                            <td>{{ $jobApplication->job->applications->count() }} Aplicaciones</td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="action-dots float-end">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li><a class="dropdown-item" href="{{ route("jobDetail",$jobApplication->job_id) }}"> <i class="fa fa-eye" aria-hidden="true"></i> Ver</a></li>
                                                        <li><a class="dropdown-item" href="#" onclick="removeJob({{ $jobApplication->id }})" ><i class="fa fa-trash" aria-hidden="true"></i> Eliminar</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
